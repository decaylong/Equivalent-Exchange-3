    ...
    public void processCommand(ICommandSender commandSender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            if (entityPlayer != null)
            {
                ...
                notifyOperators(commandSender, this, Messages.Commands.PLAYER_FORGET_ITEM_SUCCESS, new Object[]{commandSender.getName(), entityPlayer.getName(), itemStack.getChatComponent()});
            }
            else
            {
