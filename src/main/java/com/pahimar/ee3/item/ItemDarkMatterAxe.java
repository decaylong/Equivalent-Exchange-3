...
public class ItemDarkMatterAxe extends ItemToolModalEE implements IKeyBound, IChargeable {
    ...
    public ItemDarkMatterAxe() {
        super(Names.Tools.DARK_MATTER_AXE, 3.0f, Material.Tools.DARK_MATTER, blocksEffectiveAgainst);
    }

    @Override
    public float getStrVsBlock(ItemStack itemStack, Block block) {
        return block.getMaterial() != net.minecraft.block.material.Material.wood && block.getMaterial() != net.minecraft.block.material.Material.plants && block.getMaterial() != net.minecraft.block.material.Material.vine ? super.getStrVsBlock(itemStack, block) : this.efficiencyOnProperMaterial;
    }
