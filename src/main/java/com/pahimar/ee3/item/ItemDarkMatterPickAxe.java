...
public class ItemDarkMatterPickAxe extends ItemToolModalEE implements IKeyBound, IChargeable {
    ...
    public ItemDarkMatterPickAxe() {
        super(Names.Tools.DARK_MATTER_PICKAXE, 2f, Material.Tools.DARK_MATTER, blocksEffectiveAgainst);
    ...
    @Override
    // TODO Left off here
    public float getDigSpeed(ItemStack itemStack, BlockState blockState) {
