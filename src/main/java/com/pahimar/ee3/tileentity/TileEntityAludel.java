...
public class TileEntityAludel extends TileEntityEE implements ISidedInventory
{
    ...
    {
        return Network.INSTANCE.getPacketFrom(new MessageTileEntityAludel(this));
    }
    ...
    public void updateEntity()
    {
        ...
        if (sendUpdate)
        {
            ...
            Network.INSTANCE.sendToAllAround(new MessageTileEntityAludel(this), new NetworkRegistry.TargetPoint(this.worldObj.provider.dimensionId, (double) this.xCoord, (double) this.yCoord, (double) this.zCoord, 128d));
