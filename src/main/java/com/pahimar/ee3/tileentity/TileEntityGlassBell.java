...
public class TileEntityGlassBell extends TileEntityEE implements IInventory
{
    ...
    public void setInventorySlotContents(int slotIndex, ItemStack itemStack)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            Network.INSTANCE.sendToAllAround(new MessageTileEntityGlassBell(this), new NetworkRegistry.TargetPoint(this.worldObj.provider.dimensionId, this.xCoord, this.yCoord, this.zCoord, 128d));
        }
    ...
    {
        return Network.INSTANCE.getPacketFrom(new MessageTileEntityGlassBell(this));
    }
}
