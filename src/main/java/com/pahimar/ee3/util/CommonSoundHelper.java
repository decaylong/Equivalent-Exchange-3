...
public class CommonSoundHelper
{
    ...
    {
        Network.INSTANCE.sendToAllAround(new MessageSoundEvent(entityPlayer, soundName, volume, pitch), new NetworkRegistry.TargetPoint(entityPlayer.worldObj.provider.getDimensionId(), entityPlayer.posX, entityPlayer.posY, entityPlayer.posZ, range));
    }
}
